...
// +kubebuilder:webhook:path=/mutate-workload-jojotong-io-jojotong-io-v1-mystatefulset,mutating=true,failurePolicy=fail,sideEffects=None,groups=workload.jojotong.io.jojotong.io,resources=mystatefulsets,verbs=create;update,versions=v1,name=mmystatefulset.kb.io,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-workload-jojotong-io-jojotong-io-v1-mystatefulset,mutating=false,failurePolicy=fail,sideEffects=None,groups=workload.jojotong.io.jojotong.io,resources=mystatefulsets,verbs=create;update,versions=v1,name=vmystatefulset.kb.io,admissionReviewVersions=v1
